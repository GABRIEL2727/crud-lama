...
<div class="row mt-3">
    <div class="col">
        <table class="table table-striped table-hover table-sm">
            ...
            <?php
            $no = 1;
            if (isset($listTabelKunjungan) && is_array($listTabelKunjungan)) {
                foreach ($listTabelKunjungan as $data) {
                    ?>
                    <tr>
                        ...
                        <td><?= $data['keluhan']; ?></td>
                        <td>
                            <a href="editkunjungan.php?id=<?= $data['idKunjungan']; ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="konfirmasi.php?idkunjungan=<?= $data['idKunjungan']; ?>" class="btn btn-danger btn-sm">Hapus</a>
                        </td>
                    </tr>
                    <?php
                }
